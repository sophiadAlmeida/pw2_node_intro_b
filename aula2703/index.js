...
function deposit(){
    inquirer.prompt([
        ...
        inquirer.prompt([
            {
                name: 'amount',
                message: 'Quanto deseja depositar na conta: '
            }
        ]).then((anwser) => {
...
function checkAccount(accountName){
    if(!fs.existsSync(`àccounts/${accountName}.json`))
    {
...
function addAmount(accountName, amount){
    ...
    console.info(chalk.bgCyanBright.black(`Valor: ${amount}deposita na conta: ${accountName}`))
}
...
function withdraw(){
    inquirer.prompt([
        ...
        const accountName = answer['aacountName']
...
function removeAmount(accountName, amount){
    ...
    accountData.balance = parseFloat(accountData.balace) - parseFloat(amount)
    ...
    console.info(chalk.bgGreenBright.black(`O saque no valor: ${amount}foi realizafo na conta: ${accountData}`))
}