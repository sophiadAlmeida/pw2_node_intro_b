...
function getAccountBalance(){
    inquirer.prompt([
         ...
         if(accountData.balance < 0)
        {
             ...
             console.info(chalk.bgGreen.black(`| EAPECIAL: R$ ${accountData.limit + accountData.balance}|`))
        }
        else 
        {
            console.info(chalk.bgGreen.red(`| SALDO: R$ ${accountData.balance}|`))
            console.info(chalk.bgBlue.white(`| EAPECIAL: R$ ${accountData.limit + accountData.balance}|`))
        }
        operation()
  })
}
